...
/**
 * ApplePay class which will have all functionality used to place order and do related services using Apple pay payment method
 * @author AD20243779
 *
 */
public class ApplePay extends CommonTest {
	...
	final static Logger logger = Logger.getLogger(ApplePay.class);
	...
	public void init(ITestContext context) throws IOException, InterruptedException, AWTException {
		...
		screenShotModulePath = commonUtil.getScreenshotsModulePath(Constants.APPLE_PAY);
		// executeCsvImport();
	}
	...
	public void executeCsvImport() throws InterruptedException, AWTException {
		logger.info("[ApplePay][executeCsvImport] starts");
		...
		uploadFile(prop.getProperty(Constants.IMPORT_APPLEPAY_CSV_FILE_PATH));
		commonUtil.sleep(commonUtil.SLEEP_TIMER_5);
		...
		logger.info("[ApplePay][executeCsvImport] ends");
	}
	...
	public void executeCaptureRefund(String ExternalID, String Customer, String Location, String RequireCSVImport,
		...
		logger.info("[ApplePay][executeCaptureRefund] starts");
		...
		logger.info("[ApplePay][executeCaptureRefund] ends");
	}
	...
	public void executeCapture(String ExternalID, String Customer, String Location, String RequireCSVImport,
			String RequireEBCCheck, String ReasonCode, String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[ApplePay][executeCapture] starts");
		...
		logger.info("[ApplePay][executeCapture] ends");
	}
	...
	public void executeRefund(String ExternalID, String Customer, String Location, String RequireCSVImport,
			String RequireEBCCheck, String ReasonCode, String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[ApplePay][executeRefund] starts");
		...
		logger.info("[ApplePay][executeRefund] ends");
	}
	...
	public void executeVoid(String ExternalID, String Customer, String Location, String RequireCSVImport,
			String RequireEBCCheck, String ReasonCode, String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[ApplePay][executeVoid] starts");
		...
		logger.info("[ApplePay][executeVoid] ends");
	}
