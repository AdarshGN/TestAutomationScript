...
/**
 * PayPalExpressCheckout class which will have all functionality used to place order and do related services using PayPal express checkout payment method
 * @author AD20243779
 *
 */
public class PayPalExpressCheckout extends CommonTest {
	...
	final static Logger logger = Logger.getLogger(PayPalExpressCheckout.class);
	...
	public void init(ITestContext context) throws IOException, InterruptedException, AWTException {
		...
		screenShotModulePath = commonUtil.getScreenshotsModulePath(Constants.PAYPAL_EXPRESS_CHECKOUT);
		// executeCsvImport();
	}
	...
	public void executeCsvImport() throws InterruptedException, AWTException {
		logger.info("[PayPalExpressCheckOut][executeCsvImport] starts");
		...
		uploadFile(prop.getProperty(Constants.IMPORT_PAYPAL_EXPRESS_CHECKOUT_CSV_FILE_PATH));
		commonUtil.sleep(commonUtil.SLEEP_TIMER_2);
		...
		String message = commonUtil.getElementTextByXPath(driver, prop, Constants.IMPORT_JOB_STATUS_FIRST_ROW);
		System.out.println("Import Status:" + message.charAt(0));
		Assert.assertEquals(message.charAt(0), message.charAt(5));
		System.out.println("[PayPalExpressCheckOut][executeCsvImport] ends");
	}
	...
	public void executeCaptureRefund(String ExternalID, String Customer, String Location, String RequireCSVImport,
		...
		logger.info("[PayPalExpressCheckOut][executeCaptureRefund] starts");
		executeCapture(ExternalID, Customer, Location, RequireCSVImport, RequireEBCCheck, ReasonCode, DecisionMsg,
				TestScenario);
		executeRefund(ExternalID, Customer, Location, RequireCSVImport, RequireEBCCheck, ReasonCode, DecisionMsg,
				TestScenario);
		logger.info("[PayPalExpressCheckOut][executeCaptureRefund] ends");
	}
	...
	public void executeCapture(String ExternalID, String Customer, String Location, String RequireCSVImport,
			String RequireEBCCheck, String ReasonCode, String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[PayPalExpressCheckOut][executeCapture] starts");
		...
		logger.info("[PayPalExpressCheckOut][executeCapture] ends");
	}
	...
	public void executeRefund(String ExternalID, String Customer, String Location, String RequireCSVImport,
			String RequireEBCCheck, String ReasonCode, String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[PayPalExpressCheckOut][executeRefund] starts");
		...
		logger.info("[PayPalExpressCheckOut][executeRefund] ends");
	}
	...
	public void executeVoid(String ExternalID, String Customer, String Location, String RequireCSVImport,
			String RequireEBCCheck, String ReasonCode, String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[PayPalExpressCheckOut][executeVoid] starts");
		...
		logger.info("[PayPalExpressCheckOut][executeVoid] ends");
	}

	@Test(dataProvider = Constants.GET_DATA, retryAnalyzer = RetryFailedTestCases.class)
	/**
	 * This method is used to execute a delayed shipment service
	 * @param ExternalID String containing external id used to create an order
	 * @param Customer String containing name of customer placing order
	 * @param Location String containing location of order in which services are to be executed
	 * @param Items String containing Items which are to be ordered
	...
	public void executeDelayedShipment(String ExternalID, String Customer, String Location, String Items,
		...
		logger.info("[PayPalExpressCheckOut][executeDelayedShipment] starts");
		...
		logger.info("[PayPalExpressCheckOut][executeDelayedShipment] ends");
	}

	@Test(dataProvider = Constants.GET_DATA, retryAnalyzer = RetryFailedTestCases.class)
	/**
	* This method is used to execute multiple capture service
	 * @param ExternalID String containing external id used to create an order
	 * @param Customer String containing name of customer placing order
	 * @param Location String containing location of order in which services are to be executed
	 * @param Items String containing Items which are to be ordered
	...
	public void executeMultiCapture(String ExternalID, String Customer, String Location, String Items,
			String HasMultipleItem, String RequireCSVImport, String RequireEBCCheck, String ReasonCode,
			String DecisionMsg, String TestScenario) throws Exception {
		logger.info("[PayPalExpressCheckOut][executeMultiCapture] starts");
		...
		commonUtil.addLogToTestNGReport(Constants.STRING_SALE, commonUtil.getCurrentUrl(driver), saleId);
		commonUtil.addLogToTestNGReport(Constants.STRING_SALE, pnReferenceNumber);
		logger.info("[PayPalExpressCheckOut][executeMultiCapture] ends");
	}
